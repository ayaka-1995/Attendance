...
<div class="application-list__content">
    ...
    <div class="application__tab">
        ...
        <label class="application__tab--input" for="tab1">承認待ち</label>
        <input class="application__tab--input" id="tab2" type="radio" name="tab-item">
        <label class="application__tab--input" for="tab2">承認済み</label>
            ...
            <table class="table">
                ...
                @foreach($applications as $application)
                    ...
                    <tr class="table__row">
                        ...
                        <td class="table__description">
                            <p class="table__description--item">{{ $application->application__date }}</p>
                        </td>
                        <td class="table__description">
        ...
        <div class="tab__content" id="content2">
            <table class="table">
                ...
                @foreach($applications as $application)
                    @if($application->application_status ==='承認済み')
                    <tr class="table__row">
                        <td class="table__description">
                            <p class="table__description--item">{{ $application->approval__status }}</p>
                        </td>
                        <td class="table__description">
                            <p class="table__description--item">{{ $application->user->name }}</p>
                        </td>
                        ...
                        <td class="table__description">
                            <a class="table__item--detail-link" href="{{ url('/stamp_correction_request/approve/' . $application['id'])}}">修正</a>
                        </td>
                    </tr>
                    @endif
                @endforeach
